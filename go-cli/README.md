...
AQL-driven CLI and REPL for the Answerbook SDK. Positional arguments are
...
./answerbook-cli list book_of_answer
./answerbook-cli load 1 book_of_answer
./answerbook-cli load '{id:1}' book_of_answer
