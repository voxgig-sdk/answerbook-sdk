...
func registerSDKWords(r *eng.Registry, client *sdk.AnswerbookSDK) {
...
func runOp(client *sdk.AnswerbookSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
