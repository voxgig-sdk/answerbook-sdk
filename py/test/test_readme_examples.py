# Answerbook SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AnswerbookSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AnswerbookSDK(...) and AnswerbookSDK.test(...) become
#      AnswerbookSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "answerbook_sdk"
_SDK_CLASS = "AnswerbookSDK"
...
_ENTITIES = {
    "BookOfAnswer": "book_of_answer",
    "GetApiDoc": "get_api_doc",
    "MarketData": "market_data",
    "PoetryOracle": "poetry__oracle",
    "Tool": "tool",
    "Word": "word",
    "WordsLearning": "words_learning",
}
