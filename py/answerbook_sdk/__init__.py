...
from answerbook_sdk.utility import register

# Load features
from answerbook_sdk.feature.base_feature import AnswerbookBaseFeature
from answerbook_sdk.features import _has_feature, _make_feature
...
class AnswerbookSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "AnswerbookSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AnswerbookSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def BookOfAnswer(self, data=None) -> "BookOfAnswerEntity":
        ...
        from answerbook_sdk.entity.book_of_answer_entity import BookOfAnswerEntity
    ...
    def GetApiDoc(self, data=None) -> "GetApiDocEntity":
        ...
        from answerbook_sdk.entity.get_api_doc_entity import GetApiDocEntity
    ...
    def MarketData(self, data=None) -> "MarketDataEntity":
        ...
        from answerbook_sdk.entity.market_data_entity import MarketDataEntity
    ...
    def WordsLearning(self, data=None) -> "WordsLearningEntity":
        ...
        from answerbook_sdk.entity.words_learning_entity import WordsLearningEntity
