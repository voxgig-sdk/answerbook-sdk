...
class BookOfAnswerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BookOfAnswerEntity(self._client, opts)
    ...
    def data_get(self) -> BookOfAnswer:
    ...
    def match_get(self) -> BookOfAnswer:
    ...
    def load(self, reqmatch=None, ctrl=None) -> BookOfAnswer:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.BookOfAnswer().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
