...
class WordsLearningEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WordsLearningEntity(self._client, opts)
    ...
    def data_get(self) -> WordsLearning:
    ...
    def match_get(self) -> WordsLearning:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WordsLearning]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WordsLearning().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
