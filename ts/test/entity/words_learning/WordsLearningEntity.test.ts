...
describe('WordsLearningEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'words_learning.' + op, live)) return
    }
    ...
    let words_learning_ref01_data = Object.values(setup.data.existing.words_learning)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/words_learning/WordsLearningTestData.json')
