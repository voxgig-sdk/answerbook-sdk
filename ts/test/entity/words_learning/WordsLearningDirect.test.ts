...
describe('WordsLearningDirect', async () => {
  ...
  test('direct-list-words_learning', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-words_learning', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['ANSWERBOOK_TEST_WORDS_LEARNING_ENTID']
