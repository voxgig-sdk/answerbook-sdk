...
describe('PoetryOracleEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (maybeSkipControl(t, 'entityOp', 'poetry__oracle.' + op, live)) return
    }
    ...
    let poetry__oracle_ref01_data = Object.values(setup.data.existing.poetry__oracle)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/poetry__oracle/PoetryOracleTestData.json')
