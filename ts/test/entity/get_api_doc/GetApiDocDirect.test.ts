...
describe('GetApiDocDirect', async () => {
  ...
  test('direct-load-get_api_doc', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-get_api_doc', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['ANSWERBOOK_TEST_GET_API_DOC_ENTID']
