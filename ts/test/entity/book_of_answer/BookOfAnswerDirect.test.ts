...
describe('BookOfAnswerDirect', async () => {
  ...
  test('direct-load-book_of_answer', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-book_of_answer', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['ANSWERBOOK_TEST_BOOK_OF_ANSWER_ENTID']
