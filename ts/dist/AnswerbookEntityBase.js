...
exports.AnswerbookEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends AnswerbookEntityBase<Advice>`.
class AnswerbookEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.AnswerbookEntityBase = AnswerbookEntityBase;
//# sourceMappingURL=AnswerbookEntityBase.js.map