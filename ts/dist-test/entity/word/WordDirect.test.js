...
(0, node_test_1.describe)('WordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-word', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-word', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["category01", "word01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ANSWERBOOK_TEST_WORD_ENTID'];
...
//# sourceMappingURL=WordDirect.test.js.map