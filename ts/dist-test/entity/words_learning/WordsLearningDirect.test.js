...
(0, node_test_1.describe)('WordsLearningDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AnswerbookSDK({
    ...
    (0, node_test_1.test)('direct-list-words_learning', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-words_learning', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AnswerbookSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['ANSWERBOOK_TEST_WORDS_LEARNING_ENTID'];
    ...
    const client = new __1.AnswerbookSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=WordsLearningDirect.test.js.map