...
(0, node_test_1.describe)('BookOfAnswerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'book_of_answer.' + op, live))
                return;
        }
        ...
        let book_of_answer_ref01_data = Object.values(setup.data.existing.book_of_answer)[0];
        // LOAD
        const book_of_answer_ref01_ent = client.BookOfAnswer();
        const book_of_answer_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(book_of_answer_ref01_data_dt0.id === book_of_answer_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/book_of_answer/BookOfAnswerTestData.json');
    ...
    let idmap = transform(['book_of_answer01', 'book_of_answer02', 'book_of_answer03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=BookOfAnswerEntity.test.js.map