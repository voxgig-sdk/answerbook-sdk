...
(0, node_test_1.describe)('BookOfAnswerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-book_of_answer', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-book_of_answer', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ANSWERBOOK_TEST_BOOK_OF_ANSWER_ENTID'];
...
//# sourceMappingURL=BookOfAnswerDirect.test.js.map