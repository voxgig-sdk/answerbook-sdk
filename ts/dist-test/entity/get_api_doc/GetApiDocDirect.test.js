...
(0, node_test_1.describe)('GetApiDocDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_api_doc', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_api_doc', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ANSWERBOOK_TEST_GET_API_DOC_ENTID'];
...
//# sourceMappingURL=GetApiDocDirect.test.js.map