...
function envOverride(m) {
    if ('TRUE' === process.env.ANSWERBOOK_TEST_LIVE ||
        'TRUE' === process.env.ANSWERBOOK_TEST_OVERRIDE) {
    ...
    m.ANSWERBOOK_TEST_EXPLAIN = process.env.ANSWERBOOK_TEST_EXPLAIN || m.ANSWERBOOK_TEST_EXPLAIN;
    return m;
}
