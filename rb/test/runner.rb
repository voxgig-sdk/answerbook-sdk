...
module AnswerbookTestRunner
  ...
  def self.env_override(m)
    live = getenv("ANSWERBOOK_TEST_LIVE")
    override = getenv("ANSWERBOOK_TEST_OVERRIDE")
    ...
    explain = getenv("ANSWERBOOK_TEST_EXPLAIN")
    m["ANSWERBOOK_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AnswerbookTestRunner
Helpers = AnswerbookHelpers
Vs = VoxgigStruct
