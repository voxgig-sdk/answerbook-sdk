...
class MarketDataEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ANSWERBOOK_TEST_MARKET_DATA_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def market_data_basic_setup(extra)
  ...
  entid_env_raw = ENV["ANSWERBOOK_TEST_MARKET_DATA_ENTID"]
