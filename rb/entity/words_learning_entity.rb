...
class WordsLearningEntity
  ...
  def make
    opts = @_entopts.dup
    WordsLearningEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [WordsLearningListMatch, Hash, nil] match filter (any subset of
  #   WordsLearning fields); defaults to nil, treated as an empty match that lists all.
