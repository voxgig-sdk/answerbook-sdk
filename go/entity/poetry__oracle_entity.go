...
type PoetryOracleEntity struct {
	name    string
...
func NewPoetryOracleEntity(client *core.AnswerbookSDK, entopts map[string]any) *PoetryOracleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PoetryOracleEntity) GetName() string { return e.name }
...
func (e *PoetryOracleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PoetryOracleEntity) Deleted() bool {
	return e.deleted
}


func (e *PoetryOracleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPoetryOracleEntity(e.client, opts)
}

func (e *PoetryOracleEntity) Data(args ...any) any {
...
func (e *PoetryOracleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PoetryOracle; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PoetryOracleEntity) DataTyped(data ...PoetryOracle) PoetryOracle {
	if len(data) > 0 {
		return typedFrom[PoetryOracle](e.Data(asMap(data[0])))
	}
	return typedFrom[PoetryOracle](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PoetryOracle (all fields
// optional at the wire level).
func (e *PoetryOracleEntity) MatchTyped(match ...PoetryOracle) PoetryOracle {
	if len(match) > 0 {
		return typedFrom[PoetryOracle](e.Match(asMap(match[0])))
	}
	return typedFrom[PoetryOracle](e.Match())
}
...
func (e *PoetryOracleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PoetryOracleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PoetryOracleLoadMatch and returns an PoetryOracle. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PoetryOracleEntity) LoadTyped(reqmatch PoetryOracleLoadMatch, ctrl map[string]any) (PoetryOracle, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PoetryOracle{}, err
	}
	return typedFrom[PoetryOracle](res), nil
}



func (e *PoetryOracleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PoetryOracleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PoetryOracleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PoetryOracleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PoetryOracleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
