...
type BookOfAnswerEntity struct {
	name    string
...
func NewBookOfAnswerEntity(client *core.AnswerbookSDK, entopts map[string]any) *BookOfAnswerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BookOfAnswerEntity) GetName() string { return e.name }
...
func (e *BookOfAnswerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BookOfAnswerEntity) Deleted() bool {
	return e.deleted
}


func (e *BookOfAnswerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBookOfAnswerEntity(e.client, opts)
}

func (e *BookOfAnswerEntity) Data(args ...any) any {
...
func (e *BookOfAnswerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BookOfAnswer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BookOfAnswerEntity) DataTyped(data ...BookOfAnswer) BookOfAnswer {
	if len(data) > 0 {
		return typedFrom[BookOfAnswer](e.Data(asMap(data[0])))
	}
	return typedFrom[BookOfAnswer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BookOfAnswer (all fields
// optional at the wire level).
func (e *BookOfAnswerEntity) MatchTyped(match ...BookOfAnswer) BookOfAnswer {
	if len(match) > 0 {
		return typedFrom[BookOfAnswer](e.Match(asMap(match[0])))
	}
	return typedFrom[BookOfAnswer](e.Match())
}
...
func (e *BookOfAnswerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BookOfAnswerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BookOfAnswerLoadMatch and returns an BookOfAnswer. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BookOfAnswerEntity) LoadTyped(reqmatch BookOfAnswerLoadMatch, ctrl map[string]any) (BookOfAnswer, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BookOfAnswer{}, err
	}
	return typedFrom[BookOfAnswer](res), nil
}



func (e *BookOfAnswerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BookOfAnswerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BookOfAnswerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BookOfAnswerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BookOfAnswerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
