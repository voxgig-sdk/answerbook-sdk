...
type WordsLearningEntity struct {
	name    string
...
func NewWordsLearningEntity(client *core.AnswerbookSDK, entopts map[string]any) *WordsLearningEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WordsLearningEntity) GetName() string { return e.name }
...
func (e *WordsLearningEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WordsLearningEntity) Deleted() bool {
	return e.deleted
}


func (e *WordsLearningEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWordsLearningEntity(e.client, opts)
}

func (e *WordsLearningEntity) Data(args ...any) any {
...
func (e *WordsLearningEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WordsLearning; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WordsLearningEntity) DataTyped(data ...WordsLearning) WordsLearning {
	if len(data) > 0 {
		return typedFrom[WordsLearning](e.Data(asMap(data[0])))
	}
	return typedFrom[WordsLearning](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WordsLearning (all fields
// optional at the wire level).
func (e *WordsLearningEntity) MatchTyped(match ...WordsLearning) WordsLearning {
	if len(match) > 0 {
		return typedFrom[WordsLearning](e.Match(asMap(match[0])))
	}
	return typedFrom[WordsLearning](e.Match())
}
...
func (e *WordsLearningEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WordsLearningEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *WordsLearningEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WordsLearningListMatch and returns []WordsLearning. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *WordsLearningEntity) ListTyped(reqmatch WordsLearningListMatch, ctrl map[string]any) ([]WordsLearning, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[WordsLearning](res), nil
}



func (e *WordsLearningEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WordsLearningEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WordsLearningEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WordsLearningEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
