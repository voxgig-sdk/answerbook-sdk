...
func NewWordEntity(client *core.AnswerbookSDK, entopts map[string]any) *WordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WordEntity) GetName() string { return e.name }
...
func (e *WordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WordEntity) Deleted() bool {
	return e.deleted
}


func (e *WordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWordEntity(e.client, opts)
}

func (e *WordEntity) Data(args ...any) any {
...
func (e *WordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Word; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WordEntity) DataTyped(data ...Word) Word {
	if len(data) > 0 {
		return typedFrom[Word](e.Data(asMap(data[0])))
	}
	return typedFrom[Word](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Word (all fields
// optional at the wire level).
func (e *WordEntity) MatchTyped(match ...Word) Word {
	if len(match) > 0 {
		return typedFrom[Word](e.Match(asMap(match[0])))
	}
	return typedFrom[Word](e.Match())
}
...
func (e *WordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WordEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WordLoadMatch and returns an Word. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WordEntity) LoadTyped(reqmatch WordLoadMatch, ctrl map[string]any) (Word, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Word{}, err
	}
	return typedFrom[Word](res), nil
}



func (e *WordEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WordEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
