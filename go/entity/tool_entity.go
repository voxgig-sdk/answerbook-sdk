...
func NewToolEntity(client *core.AnswerbookSDK, entopts map[string]any) *ToolEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ToolEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
