...
const testSeed = `map[string]any{"entity": map[string]any{"book_of_answer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_api_doc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "market_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "poetry__oracle": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tool": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "word": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "words_learning": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
