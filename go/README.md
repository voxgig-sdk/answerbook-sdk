...
The Golang SDK for the Answerbook API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/answerbook-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/answerbook-sdk=../path/to/github.com/voxgig-sdk/answerbook-sdk
```
...
```
github.com/voxgig-sdk/answerbook-sdk/
...
The root package (`github.com/voxgig-sdk/answerbook-sdk`) re-exports everything needed
