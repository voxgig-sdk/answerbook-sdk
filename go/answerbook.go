...
// instead of `sdk.NewAnswerbookSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AnswerbookSDK  { return NewAnswerbookSDK(nil) }
func Test() *AnswerbookSDK { return TestSDK(nil, nil) }
