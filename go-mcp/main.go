// Command Answerbook-mcp is an MCP server exposing the Answerbook
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Answerbook_list  — list records of an entity
//	Answerbook_load  — load a single record of an entity
//
