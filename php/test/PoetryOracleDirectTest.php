...
class PoetryOracleDirectTest extends TestCase
{
    public function test_direct_load_poetry__oracle(): void
    {
        $setup = poetry__oracle_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-poetry__oracle", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
