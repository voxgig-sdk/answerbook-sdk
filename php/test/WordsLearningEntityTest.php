...
class WordsLearningEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = AnswerbookSDK::test($seed, null);
        $seen = iterator_to_array($base->WordsLearning(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->WordsLearning(null)->stream("list", null, null) as $item) {
