...
// Answerbook SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AnswerbookSDK::test)
...
{
    private const SDK_CLASS = 'AnswerbookSDK';
    ...
    private const SDK_BASE = 'answerbook_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../answerbook_sdk.php';
