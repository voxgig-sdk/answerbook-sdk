...
class AnswerbookTestRunner
{
    ...
    {
        $live = self::getenv('ANSWERBOOK_TEST_LIVE');
        $override = self::getenv('ANSWERBOOK_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ANSWERBOOK_TEST_EXPLAIN');
...
class_alias('AnswerbookTestRunner', 'Runner');
class_alias('AnswerbookHelpers', 'Helpers');
