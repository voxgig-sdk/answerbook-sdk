...
class MarketDataEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ANSWERBOOK_TEST_MARKET_DATA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function market_data_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ANSWERBOOK_TEST_MARKET_DATA_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ANSWERBOOK_TEST_MARKET_DATA_ENTID"]);
