...
class GetApiDocDirectTest extends TestCase
{
    public function test_direct_load_get_api_doc(): void
    {
        $setup = get_api_doc_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_api_doc", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
