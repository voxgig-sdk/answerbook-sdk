...
// Answerbook SDK idempotency feature
...
class AnswerbookIdempotencyFeature extends AnswerbookBaseFeature
{
    ...
    private function _mutating(AnswerbookContext $ctx): bool
    {
