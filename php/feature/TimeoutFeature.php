...
// Answerbook SDK timeout feature
...
class AnswerbookTimeoutFeature extends AnswerbookBaseFeature
{
    ...
    private function _with_timeout(AnswerbookContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AnswerbookContext $_ctx, float $ms): void
    {
        $client = $this->client;
