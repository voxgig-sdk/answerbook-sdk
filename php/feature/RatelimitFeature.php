...
// Answerbook SDK ratelimit feature
...
class AnswerbookRatelimitFeature extends AnswerbookBaseFeature
{
    ...
    private function _acquire(AnswerbookContext $ctx): void
    {
    ...
    private function _track(AnswerbookContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
