...
// Answerbook SDK clienttrack feature
...
class AnswerbookClienttrackFeature extends AnswerbookBaseFeature
{
    ...
    public function PostConstruct(AnswerbookContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Answerbook-SDK';
