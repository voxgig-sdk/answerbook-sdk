...
// Answerbook SDK telemetry feature
...
class AnswerbookTelemetryFeature extends AnswerbookBaseFeature
{
    ...
    private function _close(AnswerbookContext $ctx, bool $ok): void
    {
