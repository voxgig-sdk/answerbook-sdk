...
// Answerbook SDK streaming feature
...
class AnswerbookStreamingFeature extends AnswerbookBaseFeature
{
    ...
    private function _iterate(AnswerbookResult $result): \Generator
    {
    ...
    private function _streamable(AnswerbookContext $ctx): bool
    {
