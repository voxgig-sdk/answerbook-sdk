...
// Answerbook SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AnswerbookTestFeature extends AnswerbookBaseFeature
{
    ...
    public function init(AnswerbookContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AnswerbookContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AnswerbookParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AnswerbookContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AnswerbookContext $ctx, $op, $args): array
    {
