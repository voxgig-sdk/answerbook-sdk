...
// Answerbook SDK PoetryOracle entity
...
class PoetryOracleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PoetryOracleEntity($this->_client, $opts);
    }

    /**
     * @param PoetryOracle|array $args PoetryOracle data (assoc-array) to store.
     */
    ...
    /**
     * @return PoetryOracle|array The current PoetryOracle data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PoetryOracle fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PoetryOracle fields).
     */
     ...
     *
     * @param PoetryOracleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PoetryOracleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PoetryOracle|array The loaded PoetryOracle as an assoc-array at the
