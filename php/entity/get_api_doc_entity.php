...
// Answerbook SDK GetApiDoc entity
...
class GetApiDocEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetApiDocEntity($this->_client, $opts);
    }

    /**
     * @param GetApiDoc|array $args GetApiDoc data (assoc-array) to store.
     */
    ...
    /**
     * @return GetApiDoc|array The current GetApiDoc data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetApiDoc fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetApiDoc fields).
     */
    ...
    /**
     * Load a single GetApiDoc.
     *
     * @param GetApiDocLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetApiDocLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetApiDoc|array The loaded GetApiDoc as an assoc-array at the
