...
class WordEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WordEntity($this->_client, $opts);
    }

    /**
     * @param Word|array $args Word data (assoc-array) to store.
     */
    ...
    /**
     * @return Word|array The current Word data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Word fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Word fields).
     */
     ...
     * Load a single Word.
     *
     * @param WordLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WordLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Word|array The loaded Word as an assoc-array at the
