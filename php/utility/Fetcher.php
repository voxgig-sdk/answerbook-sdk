...
// Answerbook SDK utility: fetcher

class AnswerbookFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AnswerbookSDK/1.0)';
    ...
    public static function call(AnswerbookContext $ctx, string $fullurl, array $fetchdef): array
    {
