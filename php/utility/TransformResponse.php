...
// Answerbook SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class AnswerbookTransformResponse
{
    public static function call(AnswerbookContext $ctx): mixed
    {
        ...
        $transform = AnswerbookHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
