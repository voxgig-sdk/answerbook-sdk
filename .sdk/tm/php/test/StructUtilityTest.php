...
// Answerbook SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AnswerbookOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AnswerbookOmni::structfix($now, Struct::undef()))
                        !== json_encode(AnswerbookOmni::structfix($val, Struct::undef()))) {
