...
class AnswerbookProxyFeature extends AnswerbookBaseFeature
{
    ...
    public function init(AnswerbookContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AnswerbookContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
