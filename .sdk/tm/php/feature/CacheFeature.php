...
class AnswerbookCacheFeature extends AnswerbookBaseFeature
{
    ...
    private function _through(AnswerbookContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
