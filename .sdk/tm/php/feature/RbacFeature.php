...
class AnswerbookRbacFeature extends AnswerbookBaseFeature
{
    ...
    private function _required(AnswerbookContext $ctx): ?string
    {
    ...
    private function _reject(AnswerbookContext $ctx, string $required): void
    {
    ...
    private function _track(AnswerbookContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
