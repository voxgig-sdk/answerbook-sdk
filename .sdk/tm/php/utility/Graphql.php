...
// Answerbook SDK utility: graphql
//
...
class AnswerbookGraphql
{
    ...
    // equivalent.
    public static function body(AnswerbookContext $ctx): mixed
    {
    ...
    public static function errors(AnswerbookContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
