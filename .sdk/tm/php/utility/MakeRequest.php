...
// Answerbook SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AnswerbookMakeRequest
{
    public static function call(AnswerbookContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AnswerbookResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AnswerbookResponse($fetched);
        } else {
