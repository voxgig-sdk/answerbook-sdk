...
from projectname_sdk import AnswerbookSDK
from projectname_sdk.core.spec import AnswerbookSpec
from projectname_sdk.core.result import AnswerbookResult
from projectname_sdk.core.response import AnswerbookResponse
from projectname_sdk.core.operation import AnswerbookOperation
from projectname_sdk.core.error import AnswerbookError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import AnswerbookBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return AnswerbookError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = AnswerbookSDK.test(None, None)
        ...
        class TestInitFeature(AnswerbookBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(AnswerbookBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = AnswerbookSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = AnswerbookSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = AnswerbookSDK.test(None, setup_opts)
