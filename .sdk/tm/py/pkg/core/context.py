...
from projectname_sdk.core.control import AnswerbookControl
...
class AnswerbookContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, AnswerbookSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, AnswerbookResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AnswerbookResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AnswerbookError(code, msg, self)
