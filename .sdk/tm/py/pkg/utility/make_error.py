# Answerbook SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, AnswerbookError):
        errmsg = err.msg
    ...
    msg = "AnswerbookSDK: " + opname + ": " + errmsg
    ...
    sdk_err = AnswerbookError("", msg, ctx)
