...
|---|---|---|
| `ts/` | @voxgig-sdk/answerbook-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/answerbook-sdk \
      --repository voxgig-sdk/answerbook-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/answerbook-sdk` shows it, and
`npm trust revoke @voxgig-sdk/answerbook-sdk --id=<id>` removes it.
