...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/answerbook` | `npm install @voxgig-sdk/answerbook` |
| Python | `voxgig-sdk-answerbook` | `pip install voxgig-sdk-answerbook` |
| PHP | `voxgig-sdk/answerbook` | `composer require voxgig-sdk/answerbook` |
| Golang | `github.com/voxgig-sdk/answerbook-sdk/go` | `go get github.com/voxgig-sdk/answerbook-sdk/go` |
| Ruby | `voxgig-sdk-answerbook` | `gem install voxgig-sdk-answerbook` |
| Lua | `voxgig-sdk-answerbook` | `luarocks install voxgig-sdk-answerbook` |
