...
describe("PoetryOracleDirect", function()
  it("should direct-load-poetry__oracle", function()
    local setup = poetry__oracle_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-poetry__oracle", setup.live and "live" or "unit")
...
function poetry__oracle_direct_setup(mockres)
