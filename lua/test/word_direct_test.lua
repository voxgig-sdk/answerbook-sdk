...
describe("WordDirect", function()
  it("should direct-load-word", function()
    local setup = word_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-word", setup.live and "live" or "unit")
...
function word_direct_setup(mockres)
