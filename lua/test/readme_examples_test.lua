...
local SDK_MODULE = "answerbook_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["book_of_answer"] = { ["test01"] = { id = "test01" } }, ["get_api_doc"] = { ["test01"] = { id = "test01" } }, ["market_data"] = { ["test01"] = { id = "test01" } }, ["poetry__oracle"] = { ["test01"] = { id = "test01" } }, ["tool"] = { ["test01"] = { id = "test01" } }, ["word"] = { ["test01"] = { id = "test01" } }, ["words_learning"] = { ["test01"] = { id = "test01" } } } }'
