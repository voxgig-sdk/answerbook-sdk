...
describe("GetApiDocDirect", function()
  it("should direct-load-get_api_doc", function()
    local setup = get_api_doc_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_api_doc", setup.live and "live" or "unit")
...
function get_api_doc_direct_setup(mockres)
