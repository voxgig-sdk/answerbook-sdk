...
describe("WordsLearningDirect", function()
  it("should direct-list-words_learning", function()
    local setup = words_learning_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-words_learning", setup.live and "live" or "unit")
...
function words_learning_direct_setup(mockres)
