...
local BookOfAnswerEntity = {}
BookOfAnswerEntity.__index = BookOfAnswerEntity


function BookOfAnswerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BookOfAnswerEntity)
  self._name = "book_of_answer"
  self._client = client
...
function BookOfAnswerEntity:get_name()
  return self._name
end


function BookOfAnswerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BookOfAnswerEntity.new(self._client, opts)
end
...
function BookOfAnswerEntity:mark_deleted()
  self._deleted = true
end


function BookOfAnswerEntity:deleted()
  return true == self._deleted
end


function BookOfAnswerEntity:data_set(args)
  if args ~= nil then
...
function BookOfAnswerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BookOfAnswerEntity:match_set(args)
  if args ~= nil then
...
function BookOfAnswerEntity:match_get()
...
function BookOfAnswerEntity:stream(action, args, callopts)
...
---@param reqmatch BookOfAnswerLoadMatch
---@param ctrl? table
---@return BookOfAnswer
---@return string? err
function BookOfAnswerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BookOfAnswerEntity:_run_op(ctx, post_done)
  local utility = self._utility
